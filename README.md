...
Сборник из 8 лабораторных работ с отчётами и исходным кодом.
...
2. Откройте отчёт (PDF или MD) для ознакомления с заданием и результатами.
3. Изучите исходный код в папке `src/`.
4. При необходимости используйте дополнительные материалы.

## Лицензия

Проект распространяется под лицензией [MIT](LICENSE) / [CC BY 4.0](LICENSE).
